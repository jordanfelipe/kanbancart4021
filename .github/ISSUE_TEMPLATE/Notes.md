...
TODO: Make a separate function call for each additional piece of information in Admin_Controller_Sale_Order.ocmod.xml. Currently, '$this->model_sale_order->getProductInfo' call returns array.
...
### 04JUL2023:
Used Let's Encrypt via certbot to get SSL. Upsdate the config.php files messily. 
Front end works. 
...
When resetting base to 4.0.2.1, keep ./system/system/db_schema.php, ./image/no_image.png, ./image/placeholder.png
